...
Архитектура реализована и зависимости установлены. Рабочий runtime по умолчанию выключен. Офлайн-бенчмарк Conversation Brain v1 был запущен отдельно на настроенной модели; он не включает Telegram и не изменяет бизнес-БД.
