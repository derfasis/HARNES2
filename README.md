...
Архитектура реализована и зависимости установлены. Модель ещё не подключена. Тесты и вызовы ИИ по просьбе владельца не запускались; наличие кода не означает проверенную работу с провайдером.
