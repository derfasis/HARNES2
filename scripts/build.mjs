...
for (const dir of ['business','adapters','public','scripts','config','contracts','partner','tests','benchmarks/opportunity-projection-v0','benchmarks/discovery-v1']) walk(path.join(root,dir));
let checked = 0;
