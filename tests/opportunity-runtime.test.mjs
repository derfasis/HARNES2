...
test('no-tool runtime uses existing worker, no business URL/token/tools, one iteration', async t=>{
  ...
  assert.match(argv[0],/scripts[/\\]situation_router_worker.py$/);assert.deepEqual(envelope.tools,[]);assert.equal(envelope.model.maxIterations,1);
